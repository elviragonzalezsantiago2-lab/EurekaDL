...
class ModuleInterface:
    ...
    def search(self, media_type, query, limit=10):
        raise NotImplementedError('Search is not implemented for the bandcamp stub. See modules/bandcamp/README.md')

    def custom_url_parse(self, url):
        raise NotImplementedError('URL parsing is not implemented for the bandcamp stub.')

    # Downloader expects download-like methods; implement as needed.
    def download_track(self, track_id, **kwargs):
        raise NotImplementedError('Download not implemented for bandcamp stub.')
